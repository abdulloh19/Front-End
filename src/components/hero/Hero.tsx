...
const Hero = () => {
  return (
    <Card mt={10}>
      <CardBody p={10}>
        <Grid minH={"50vh"} gridTemplateColumns={{ base: "100%", md: "50% 50%" }} gap={5} justifyContent={"center"} alignItems={"center"}>
          <Stack spacing={3}>
            <Heading>Find A Perfect Online Course</Heading>
            <Text>You can access 7900+ different courses from 600 profissional trainers for free</Text>
            <Grid gridTemplateColumns={{ base: "100%", md: "50% 50%" }} gap={5}>
              <Button colorScheme="facebook" h={14} rightIcon={<VscDebugStart />}>
                Start Learing
              </Button>
